...
class AbsensiDiniyahController extends Controller
{
    protected $model;
    ...
    {
        $data = $this->model->with('santri', 'tahunAkademik')->where('departemen', 'Diniyah')->get();
        $santri = Santri::all();
        return view('pages.absensi.diniyah', compact('data', 'santri'));
    }
