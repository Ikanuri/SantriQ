<?php
namespace App\Exports;use App\Models\Absensi;
use Maatwebsite\Excel\Concerns\FromCollection;
use Maatwebsite\Excel\Concerns\WithHeadings;

class AbsensiPengajianExport implements FromCollection, WithHeadings
{
    public function collection()
    {
        // Asumsikan model Absensi punya relasi ke Santri dan TahunAkademik
        return Absensi::where('departemen', 'Pengajian')
            ->get()
